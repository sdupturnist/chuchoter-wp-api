          ...
          <div className="mx-auto 2xl:w-[70%] xl:w-[80%] grid">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-[10px] lg:gap-[50px] lg:mb-0 mb-[30px]">
                ...
                {cartItems && cartItems.length !== 0 ? (
                  ...
                  <NoData
                    title={transalateText(
                      siteTransalations?.generalTranslations?.cartEmpty,
                      language
                    )}
                  />
                )}
                  ...
                  <div className="lg:border lg:rounded-[6px] rounded-none border-solid lg:border-gray-200 border-black lg:p-[20px] py-[16px] lg:mt-[20px] lg:border-t ">
                    <p className="flex justify-between w-full border-b border-solid border-gray-200 pb-[16px]">
                      <span className="block text-black text-opacity-50">
                        {transalateText(
                          siteTransalations?.generalTranslations?.subtotal,
                          language
                        )}
                      </span>
                      <span className="block text-black text-opacity-50">
                    ...
                    <p className="flex justify-between w-full border-b border-solid border-black py-[16px]">
                      <span className="block text-black text-opacity-50">
                        {transalateText(
                          siteTransalations?.generalTranslations?.delivery_fee,
                          language
                        )}
                      </span>
                      <span className="block text-black text-opacity-50">
                    ...
                    <p className="flex justify-between w-full lg:pt-[16px] pt-[16px] pb-[4px]">
                      <span className="block font-semibold text-[16px] uppercase">
                        {transalateText(
                          siteTransalations?.generalTranslations?.total,
                          language
                        )}
                      </span>
                      <span className="block font-semibold text-[16px] uppercase">
                        {parseFloat(totalAmount) + parseFloat(deliveryFee)}
                        {transalateText(
                          siteTransalations?.generalTranslations?.qr,
                          language
                        )}
              ...
              {cartItems && cartItems.length !== 0 && (
                <div
                  className={`${
                    language === "ar" ? "lg:border-r" : "lg:border-l"
                  } lg:col-span-2  border-black border-solid lg:p-[50px]`}>
                  <OrderForm
                    totalAmountOrder={
                      parseFloat(totalAmount) + parseFloat(deliveryFee)
                    }
