                ...
                <div className="flex justify-between items-center">
                    ...
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" className="mx-auto" fill="none" viewBox="0 0 23 23">
                            <path stroke= {currentTheme == 'chocolates' ?  color : '#c89a3f'} d="m10.564 5.433-.142-.125a1.14 1.14 0 0 1 .394-1.938l.192-.064a1.304 1.304 0 0 1 1.372.354c.828.9.589 2.339-.486 2.923l-.085.046-.066.036a2.814 2.814 0 1 1-2.645-4.967l1.466-.765m0 0-.652.157a11.24 11.24 0 0 0-8.417 8.82l-.778 4.074a2.925 2.925 0 0 0 1.449 3.104 17.919 17.919 0 0 0 17.823-.213l.262-.154a3.012 3.012 0 0 0 1.475-2.813l-.066-.906a12.864 12.864 0 0 0-3.018-7.391l-1.024-1.208a8.487 8.487 0 0 0-1.916-1.671 11.775 11.775 0 0 0-4.504-1.7l-.634-.099Z" />
                            <path stroke= {currentTheme == 'chocolates' ?  color : '#c89a3f'} d="m20.135 7.922-.359.392a17.004 17.004 0 0 1-15.43 5.263l-3.358-.581" />
                            <path stroke= {currentTheme == 'chocolates' ?  color : '#c89a3f'} d="m1.848 8.783.117.05a21.585 21.585 0 0 0 8.335 1.674h.492c.291 0 .582-.026.868-.077 3.438-.609 5.196-4.477 3.393-7.467l-.473-.785" />
                        </svg>
                        Chocolates
                    </Link>
                    <Link
