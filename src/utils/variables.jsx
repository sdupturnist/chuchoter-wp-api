...
export const wordpressRestApiUrlWordpressMenus = process.env.NEXT_PUBLIC_API_REST_WP_WORDPRESS_MENUS;
...
export let woocommerceConsumerKey = process.env.NEXT_PUBLIC_WOOCOMMERCE_CONSUMER_KEY
export let woocommerceConsumerSecret = process.env.NEXT_PUBLIC_WOOCOMMERCE_CONSUMER_SECRET
